...
namespace MVCStudentManagementCRUD.Models.Students
{
    public class StudentBO
    {
        ...
        {
            return $"Id: {Id}, FirstName: {FirstName}, LastName: {LastName}, MiddleName: {MiddleName}, PreferredName: {PreferredName}, DateOfBirth: {DateOfBirth}, Email: {Email}, Phone: {Phone}, Address: {Address}, GenderId: {GenderId}, EthnicityId: {EthnicityId}";
        }
